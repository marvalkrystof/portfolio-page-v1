...
import sw_encyclopedia from "../assets/sw_logo.png";
...
const workExperiences: Array<Experience> = [
  ...
  },
  {
    ...
    description:
      "It was my responsibility to monitor, review, and respond to security alerts and incidents, ensuring the timely identification of potential threats, analyzing suspicious activities, and implementing appropriate remediation measures to safeguard the organization's network and data.",
    technologies: [
      "Splunk/SPL",
      "Azure AD",
      "MS Defender",
...
const education: Array<Experience> = [
  {
    ...
    description:
      "A 3.5-year degree with a strong emphasis on practical application over theory, highlighted by a mandatory internship in the final semester. One-third of the courses are taught in English. The curriculum focuses on foundational statistics, machine learning methods, and various data-related disciplines",
    technologies: [
      "Python",
      "PHP",
      "Statistic methods and Probability theory",
  ...
  },
  {
    ...
    description:
      "Learned a bit of everything ranging from databases, networks, operating systems, and programming. This gave me a great base knowledge, which I used to further develop my skills. Mostly took interest in programming. Graduated with straight A's.",
    technologies: [
      "Database design",
      "OOP Programming",
      "Webdev",
...
const projects: Array<Experience> = [
  {
    image_path: sw_encyclopedia,
    project_name: "Star Wars Encyclopedia",
    description:
      "A simple Star Wars encyclopedia with a search feature. Serves as a practice for working with APIs, React and MUI.",
    project_link: "https://marvalkrystof-sw-encyclopedia.netlify.app/",
    technologies: [
      "React",
      "Material-UI",
      "Typescript",
  ...
  },
  {
    ...
    description:
      "Mainly serves the purpose of a portfolio and frontend developent practice.",
  ...
  },
  {
    ...
    description:
      "Tried solving the NP-complete problem using 4 different approaches. 1. Bruteforce, 2. Bruteforce with paralelization, 3. Using dynamic programming, 4. Using distributed programming (master/slave architecture)",
    project_link:
      "https://github.com/marvalkrystof/0-1-Knapsack-Problem---four-ways",
    technologies: [
      "C#",
      "Bruteforce",
      "Paralelization",
...
const certifications: Array<Experience> = [
  {
    ...
    date: "MAR 2023",
    description:
      "Essentials of database design and architecure and database programming with Oracle DB.",
