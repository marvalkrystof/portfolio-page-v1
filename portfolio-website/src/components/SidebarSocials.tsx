...
function SidebarSocials()  {
  ...
  return (
    ...
    <SocialIcon filePath={github_svg_white} link="https://github.com/marvalkrystof"></SocialIcon>
    <SocialIcon filePath={linked_in_svg} link="https://www.linkedin.com/in/krystofmarval/"></SocialIcon>
    <SocialIcon filePath={instagram_svg} link="https://www.instagram.com/k_mrvl/"></SocialIcon>
    <SocialIcon filePath={mail_svg} link="mailto:marval.krystof@seznam.cz"></SocialIcon>
    </div>
    </>
  )
}
